                ...
                <div class="container">
                    <div class="row justify-content-between gy-5">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center text-lg-start">
                            <img src="https://i.ibb.co/GJSYYh4/laptop1.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300" style={{marginLeft:"10%"}} />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row gx-0">
                        ...
                        <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                            <div class="content">
                                ...
                                <br />
                                <h5>Mr. Khalil A. Hasan has over 57 years of experiencein Banking and Finance with local and multinational institutions in diverse roles including but not limited to:</h5>
                                <br />
