...
export default function JoinIjma() {
  return (
    <div>
      ...
      {/* <br /> */}
      <br />
      <section id="JoinIjma" class="JoinIjma d-flex align-items-center section-bg">
        <div class="container">
          <div class="row justify-content-between gy-5">
            <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
              ...
              <h5 data-aos="fade-up" style={{ color: "black" }}>Using Blockchain, IJMA offers a disruptive alternative for organizations seeking to overcome the high cost, risk, and friction associated with existing Islamic Banking and Financial Services Operations.</h5>
              <br />
              <h5>IJMA effectively tackles the criticism surrounding Islamic Banks adhering to conventional banking controlled by the State Bank of Pakistan.</h5>
              <br />
              <h5 data-aos="fade-up" style={{ color: "black" }}>As you can tell by the slideshow on The Monitor Above, IJMA enables the digitization of Islamic Banking with Transparency and Security. IJMA is a permissioned Blockchain network of Islamic Financial Institutions (IFIs).</h5>
              <br />
              <br />
              <div style={{
